...
RegisterNetEvent('player:Buysnspistol')
AddEventHandler('player:Buysnspistol', function()
...
RegisterNetEvent('player:Buydbshotgun')
AddEventHandler('player:Buydbshotgun', function()
...
RegisterNetEvent('player:Buycompactrifle')
AddEventHandler('player:Buycompactrifle', function()
